    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scheduled_scan_interval', models.IntegerField(default=None, verbose_name='scheduled scan interval')),
                ...
                ('preferred_language', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='languages_plus.language')),
            ],
            options={
                'verbose_name': 'server',
